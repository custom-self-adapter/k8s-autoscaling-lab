...
*/}}
{{- define "custom-self-adapter-operator.name" -}}
...
*/}}
{{- define "custom-self-adapter-operator.fullname" -}}
...
*/}}
{{- define "custom-self-adapter-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "custom-self-adapter-operator.resourceName" -}}
{{- $fullname := include "custom-self-adapter-operator.fullname" .context }}
{{- $suffix := .suffix }}
